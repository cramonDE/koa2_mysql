...
let initial = async function() {
	...
	`);
	init_sql.push(`
		INSERT INTO \`pet\` (pet_nickname, pet_owner, pet_type, pet_weight, pet_sex, pet_birth) VALUES ('小英',"1",'英短', "20", 'female', '2010-01-02'), ('小橘',"1",'橘猫', "20", 'female', '2010-01-02'), ('小波',"1",'波斯', "20", 'female', '2010-01-02');
	`)
	init_sql.push(`
	...
	`)
	init_sql.push(`
		INSERT INTO \`comment\` (com_time, com_user, com_walk) VALUES ('2010-01-02', "1", "1"), ('2010-01-02', "2", "2"), ('2010-01-02', "3", "3");
	`)
	init_sql.push(`
